...
bool MyCollision::IsCollision(const Sphere& s1, const Sphere& s2) {
...
/// <returns>衝突しているか</returns>
bool MyCollision::IsCollision(const Sphere& s, const Plane& p) {
...
/// <param name="p">平面</param>
/// <returns>衝突しているか</returns>
bool MyCollision::IsCollision(const Line& l, const Plane& p) {
...
/// <param name="p">平面</param>
/// <returns>衝突しているか</returns>
bool MyCollision::IsCollision(const Ray& r, const Plane& p) {
...
/// <param name="p">平面</param>
/// <returns>衝突しているか</returns>
bool MyCollision::IsCollision(const Segment& s, const Plane& p) {
...
/// <param name="p">平面</param>
/// <returns>衝突しているか</returns>
bool MyCollision::IsCollision(const Triangle& triangle, const Segment& s) {
...
/// <returns></returns>
bool MyCollision::IsCollision(const AABB& aabb1, const AABB& aabb2) {
